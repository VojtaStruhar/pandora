@tool
class_name PandoraUncompressedJsonDataStorage extends PandoraDataStorage
...
func get_backend_name() -> String:
	return "Pandora Uncompressed JSON"
	
func get_backend_description() -> String:
	return "Stores data in uncompressed json at the data_directory provided. Good for debugging purposes"
...
func _get_file_path(context_id: String) -> String:
	return "%s/data.pandora.json" % [_get_directory_path(context_id)]
